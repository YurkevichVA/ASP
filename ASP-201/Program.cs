...
using ASP_201.Services.VerificationCodeGeneration;
...
builder.Services.AddSingleton<ITransliterationService, TransliterationServiceV1>();
...
// варіант 2 - автоматичне визначення версії
// попередньо треба створити підключення
